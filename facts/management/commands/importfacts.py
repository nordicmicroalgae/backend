...
ALGAEBASE = (
    Path(settings.CONTENT_DIR, "species", "facts_external_links_algaebase.txt"),
    dict(
        encoding="iso-8859-1",
        provider="AlgaeBase",
        url_template="url",
...
DYNTAXA = (
    Path(settings.CONTENT_DIR, "species", "facts_external_links_dyntaxa.txt"),
    dict(
        encoding="iso-8859-1",
        provider="Dyntaxa",
...
ENA = (
    Path(settings.CONTENT_DIR, "species", "facts_external_links_ena.txt"),
    dict(
        encoding="utf8",
        provider="ENA",
        url_template="url",
...
GBIF = (
    Path(settings.CONTENT_DIR, "species", "facts_external_links_gbif.txt"),
    dict(
        encoding="utf8",
        provider="GBIF",
        url_template="url",
...
ITIS = (
    Path(settings.CONTENT_DIR, "species", "facts_external_links_itis.txt"),
    dict(
        encoding="utf8",
        provider="ITIS",
        url_template="url",
...
IOC = (
    Path(settings.CONTENT_DIR, "species", "facts_external_links_hab_ioc.txt"),
    dict(
        encoding="utf8",
        provider="IOC",
...
IOC_UNESCO = (
    Path(settings.CONTENT_DIR, "species", "facts_ioc_toxins.txt"),
    dict(
        encoding="utf8",
        provider="IOC-UNESCO",
        collection="Harmful algae blooms",
...
NCBI = (
    Path(settings.CONTENT_DIR, "species", "facts_external_links_ncbi.txt"),
    dict(
        encoding="utf8",
        provider="NCBI",
        url_template="url",
...
NORCCA = (
    Path(settings.CONTENT_DIR, "species", "facts_external_links_norcca.txt"),
    dict(
        encoding="utf8",
        provider="NORCCA",
...
PR2 = (
    Path(settings.CONTENT_DIR, "species", "facts_external_links_pr2.txt"),
    dict(
        encoding="utf8",
        provider="PR2",
        url_template="url",
...
WORMS = (
    Path(settings.CONTENT_DIR, "species", "facts_external_links_worms.txt"),
    dict(
        encoding="utf8",
        provider="WoRMS",
...
NOMP = (
    Path(settings.CONTENT_DIR, "species", "facts_biovolumes_nomp.txt"),
    dict(
        encoding="utf_8_sig",
        provider="NOMP",
        id_field="taxon_id",
